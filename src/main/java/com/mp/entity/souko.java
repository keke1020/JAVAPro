...
public class souko {
	...
	//	名古屋
	private Integer nagoyaZaiko;
	private String kaisou_nagoya;
	private String tana_nagoya;
	...
	public Integer getNagoyaZaiko() {
		return nagoyaZaiko;
	}

	public void setNagoyaZaiko(Integer nagoyaZaiko) {
		this.nagoyaZaiko = nagoyaZaiko;
	}

	public String getKaisou_nagoya() {
		return kaisou_nagoya;
	}

	public void setKaisou_nagoya(String kaisou_nagoya) {
		this.kaisou_nagoya = kaisou_nagoya;
	}

	public String getTana_nagoya() {
		return tana_nagoya;
	}

	public void setTana_nagoya(String tana_nagoya) {
		this.tana_nagoya = tana_nagoya;
	}

	public String getMoto_nagoya() {
		return moto_nagoya;
	}

	public void setMoto_nagoya(String moto_nagoya) {
		this.moto_nagoya = moto_nagoya;
	}

	public String getMoto_nagoya_old() {
		return moto_nagoya_old;
	}

	public void setMoto_nagoya_old(String moto_nagoya_old) {
		this.moto_nagoya_old = moto_nagoya_old;
	}

	public Date getNagoya_update() {
		return nagoya_update;
	}
