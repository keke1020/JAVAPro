...
public class listServiceImpl implements listService {
	...
	public List<list1> getList1(int offset, int limit, String searchId, String searchtime_s, String searchtime_e,
			...
			String radio_soko3) {
		return listDao.getList1(offset, limit, searchId, searchtime_s, searchtime_e, searchcontain_check, searchcontain,
				searchkeiban, searchedaban, search_arrival_japan, search_arrival_soko, radio_soko1, radio_soko2,
				radio_soko3);
	}
