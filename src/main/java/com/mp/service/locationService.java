...
public interface locationService {
	List<location> getlocation(String searchFlag, String commonFlag, String istana, String orderSC, String t_kbn,
			String singuZaiko, String codeSc, String containerSc, String kaisosc, String tanaSc, String kosuSC1,
			String kosuSC2, String limitFlag, int offset, int limit);
	...
	int getLocationCountByCodes(String[] codes);
